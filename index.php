...
if(isset($_POST["a"])){
	...
	if($_POST["subjects"]=='日本史B'){
		...
		$_SESSION['answerArray'] = array(3,2,2,5,1,2,1,1,2,2,2,2,2,3,1,3,1,1,3,1,1,1,1,1,2,2,2,1,2,3,2,4,4,1,2,2,2,1,1,2,2,3,2,2,1);
		$_SESSION['answer'] = array("－",2,4,0,4,"－",2,5,3,6,1,3,2,1,2,4,3,2,4,1,0,2,3,3,3,"－",4,8,6,3,2,1,4,4,2,1,4,7,7,3,5,6,4,3,0,2,1,4,1,2,3,3,8,7,3,2,4,7,2,6,1,1,9,6,4,8,9,1,1,3,6,5,1,6,1,1,8,2,7,9,5,6,1,2,7,2,2);
		$_SESSION['points'] = array(3,2,2,3,2,2,2,2,2,2,2,2,2,2,3,3,3,3,3,3,3,3,3,3,2,2,2,2,2,3,4,3,3,2,2,3,3,4,2,2,2,4,4,2,4);
	}else if($_POST["subjects"]=='数学2・数学B'){//2019で組んでるので全体的に直す必要あり
		$_SESSION['subject'] = $_POST["subjects"];
		$_SESSION['questionNum'] = array(30,28,27,30);
		$_SESSION['allQuestion'] = 115;
		$_SESSION['bigQuestion'] = 4;
		$_SESSION['answerArray'] = array(3,1,4,2,2,2,1,2,2,3,3,3,1,1,2,1,3,2,2,2,1,2,1,2,5,2,3,1,1,3,1,1,3,4,3,3,3,3,1,2,2,2,3,1,2,4,1,2,6,2,1,2);
		$_SESSION['answer'] = array(3,2,3,3,2,3,5,3,1,2,4,5,3,5,3,1,1,1,3,"－",3,6,2,1,0,3,"－",4,7,5,2,2,1,2,4,2,4,1,0,2,2,1,"a",3,3,1,1,3,2,4,2,1,3,2,3,2,2,7,6,0,1,1,2,3,1,2,1,1,1,6,1,2,2,3,1,3,1,4,1,2,2,1,0,0,1,3,6,4,3,3,6,"－",2,3,1,2,6,2,2,"－",4,3,3,0,1,2,2,1,2,2,6,0,3,4,3);
		$_SESSION['points'] = array(2,2,3,2,2,2,2,3,2,2,2,2,2,2,2,2,2,2,3,2,2,3,2,3,3,3,1,2,1,2,1,1,2,2,2,2,2,1,2,2,2,2,1,1,2,1,2,2,2,1,1,1);
	}
	$tmp = 1;
	$html = "<table>";
